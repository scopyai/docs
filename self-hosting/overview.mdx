---
title: "Overview"
description: "What you need to run your own Scopy instance."
---
...
- An OpenRouter API key for review model calls.
...
- Configure `OPENROUTER_API_KEY` and choose review models.
- Apply Drizzle and Graphile Worker migrations.
- Route GitHub webhooks to the API.
- Ensure the worker can reach GitHub, OpenRouter, PostgreSQL, and optional Qdrant.
