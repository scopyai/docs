---
title: "Configuration"
description: "Every environment variable for self-hosted Scopy AI: API and web settings, GitHub App credentials, model configuration, key storage, and semantic search."
---
