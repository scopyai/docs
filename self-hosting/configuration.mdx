...
| `CREEM_STARTER_PRODUCT_ID`        | Yes      | None                                     | One-time $1 starter trial product id.                              |
| `STARTER_CREDIT_MICRO_USD`        | No       | `1500000`                                | Usage credits granted by the starter purchase, in micro-USD.       |
