...
description: "Learn how to use Scopy for AI code reviewer"
---

Scopy is an open-source AI code reviewer. It helps teams catch bugs, supporting the desired velocity, while keeping production safe from bugs and vulnerabilities.
...
### Where does Scopy run?

You can use hosted Scopy at [app.scopy.dev](https://app.scopy.dev) or run your own instance. Hosted Scopy is the fastest path for most teams. Self-hosting is available when you need more control over deployment, data, credentials, or model configuration.

### What does Scopy need access to?
